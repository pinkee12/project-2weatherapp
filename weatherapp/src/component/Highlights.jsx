...
function Highlights({ stats }) {
  return (
    <div className='bg-slate-600 p-2 text-slate-200 flex flex-col justify-start items text-transform scale-100 hover:scale-110 duration-200 ease-in-out cursor-pointer'>
      <h2 className='text-5m mt-2'>{stats.title}</h2>
      <div className='mt-2'>
